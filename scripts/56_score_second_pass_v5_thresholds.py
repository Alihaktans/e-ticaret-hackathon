...
ROOT = Path(".")
LABEL_PATH = ROOT / "reports/manual_review/random_review_blind_v2_assistant_clean_high_only_second_pass_corrected.csv"
SCORE_PATH = ROOT / "data/processed/v5_e5base_full900_test_proba.parquet"
OUT = ROOT / "reports/manual_review/random_clean_second_pass_v5_threshold_metrics.csv"
